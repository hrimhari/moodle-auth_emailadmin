...
$plugin->version   = 2012120302;        // The current plugin version (Date: YYYYMMDDXX)
$plugin->requires  = 2011120509;        // Requires this Moodle version
$plugin->component = 'auth_emailadmin';      // Full name of the plugin (used for diagnostics)
$plugin->maturity = MATURITY_RC;
$plugin->release = '1.0 (2012120302)';
